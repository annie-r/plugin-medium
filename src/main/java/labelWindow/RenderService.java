...
public class RenderService {
    ...
    public RenderSession createRenderSession(String layoutName) throws FileNotFoundException,
        ...
        mWidth, mHeight, mConfig.getDensityQualifier().getValue(), mXdpi, mYdpi, ScreenSize.NORMAL,
                ScreenOrientation.LANDSCAPE,ScreenRound.NOTROUND,true);*/
        HardwareConfig hardwareConfig = new HardwareConfig(
                mWidth, mHeight, mConfig.getDensityQualifier().getValue(), mXdpi, mYdpi, ScreenSize.NORMAL,
        ...
        SessionParams params = new SessionParams(
                ...
                hardwareConfig,
                mResourceResolver,
                //(LayoutlibCallback) mProjectCallback,
                mProjectCallback,
                mMinSdkVersion,
                mTargetSdkVersion,
                mLogger);
