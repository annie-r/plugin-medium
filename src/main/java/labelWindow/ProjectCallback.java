...
public class ProjectCallback implements IProjectCallback {
    ...
    @Override
    public Object getAdapterItemValue(ResourceReference resourceReference, Object o, ResourceReference resourceReference1, int i, int i1, int i2, int i3, ResourceReference resourceReference2, ViewAttribute viewAttribute, Object o1) {
        return null;
    }
